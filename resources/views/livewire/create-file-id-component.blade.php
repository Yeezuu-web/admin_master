    ...
    <div class="card-body">
        <form id="frm">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3" id="type_file">
                ...
                <div class="form-group col-md-3" id="eps">
                ...
                <div class="form-group col-md-3" id="dur">
            ...
            <!-- <div class="row"> -->
                <div class="form-group col-md-3" id="file_ext">
                ...
                <div class="form-group col-md-3" id="res">
                ...
                <div class="form-group col-md-3" id="m_e">
                ...
                <div class="form-group col-md-3" id="dub">
                ...
                <div class="form-group col-md-3" id="file_path">
                ...
                <div class="form-group col-md-3" id="file_storage">
            ...
            <!-- <div class="row"> -->
                <div class="form-group col-md-3" id="recieved">
                ...
                <div class="form-group col-md-3" id="air_dates">
                ...
                <div class="form-group col-md-3" id="file_year">
                ...
                <div class="form-group col-md-3" id="file_poster">
                ...
                <div class="form-group col-md-3" id="promo">
                ...
                <div class="form-group col-md-3" id="sys">
                ...
                <div class="form-group col-md-3" id="size">
            ...
            <!-- <div class="row"> -->
                <div class="form-group col-md-3" id="start">
                ...
                <div class="form-group col-md-3" id="end">
                ...
                <div class="form-group col-md-3" id="time">
                    <label for="period_of_time">{{ trans('cruds.file.fields.period_of_time') }}</label>
                    <div class="input-group">
                        <input class="form-control form-control-sm" type="text" name="period_of_time" id="period_of_time">
                    </div>
                </div>
                ...
                <div class="form-group col-md-3" id="s_time">
